...
logging.info('Params: testday %s, fit %d, folds %d, screen %d, maskname %s, mask %s',
...
dec_filename = '%s%s_decoder_SpaceNet_%sscreen%d_day%d_%s.jbl' %(decoder_dir,timestamp, decoder.penalty, screenp, testday, maskname)
...
coef_filename = '%s%s_coefs_SpaceNet_%sscreen%d_day%d_%s.nii' %(coef_dir,timestamp, decoder.penalty, screenp, testday, maskname)
